...
public:
    std::array<int, 3> rotors{0,0,0};
    std::array<int, 3> indicators{0,0,0};
    std::array<int, 3> rings{0,0,0};
    Plugboard plugboard;
    float score{1e-10};

    constexpr ScoredEnigmaKey() = default;
    constexpr ScoredEnigmaKey(
        std::array<int, 3> rotors,
        std::array<int, 3> indicators,
        std::array<int, 3> rings,
